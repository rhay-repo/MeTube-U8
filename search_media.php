                ...
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <form method="post" value="<?php echo $title; ?>">
                          ...
                          <!-- ~ maybe uncomment the PHP code below -->
                          <?php
                          ...
                          ?> 
                          <!-- <input type='submit' name='<?php //echo $view_title; ?>' value='View <?php //echo $view_title ?>'> -->
...
<!-- <body>
  ...
  <div class="content">
		...
		<?php
        // ~ consider putting an "if (isset(...))" arround all Media.php code
        // if (isset($_POST[$value_array[0]])) {
			// if(isset($_SESSION['media_id'])) {
				// $media_id = $_SESSION['media_id'];
				// $_SESSION['media_id'] = 9;

        //~ ADD THIS BACK MAYBE LATER
        // $media_id = $_SESSION['media_id'];

				// $query = "SELECT * FROM media WHERE title = '{$media_id}'";
        $query = "SELECT * FROM media WHERE title = '{$display_title}'";
				$result = mysqli_query($_SESSION['link'], $query) or die("Query error test: ". mysqli_error($_SESSION['link'])."\n");
